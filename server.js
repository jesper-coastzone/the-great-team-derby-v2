...
app.get('/loebsleder', page('loebsleder')); // v3.1: løbslederens tablet (stations-godkendelser)
app.get('/simulator', page('simulator')); // instruktør-træning: host + skærm + tablet på én side
